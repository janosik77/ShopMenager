...
{
    public class AItemListViewModel<T> : BaseViewModel where T : class
    {
        public AItemListViewModel(INavigationService navigationService, string title) : base(navigationService)
        {
            Title = title;
